...
<html class="no-js">
    ...
    <section id="hero-area">
      <img class="img-responsive" src="images/site-header.jpg" alt="Site Header">
    </section>
	<!--
    Header start 
	============================== -->
    ...
    <section id="about-us">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        <img class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms" src="images/cooker-img-1.png" alt="cooker-img-1">
                        <img class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms" src="images/cooker-img-2.png" alt="cooker-img-2">
                        <h2 class="heading wow fadeInUp" data-wow-duration="400ms" data-wow-delay="500ms" ><span>Leaf 'n Beans Cafe</span> </br> Visit our cafe for a freshly brewed coffee and a lip smacking food to make your day better!!! <br/> Open everyday <b>11:00AM - 10.00PM</b> near <b>Income Tax Office</b>, at <b>Shelter Chhak, Cuttack</b>.
                        <br/><br/>For Orders, Contact <b>91-9439249945</b>
                        </h2>
                     </div>
                </div><!-- .col-md-12 close -->
            </div><!-- .row close -->
                        ...
                        <ul>
                            <li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="300ms">
                                ...
                                <div class="content-right">
                                    <h3>HOUSE SPECIAL FLAT BREAD PIZZA</h3>
                                    <p>Crispy Base, With Cubes Of Cottage Cheese, Bells, Topped With Cheesy Layer...</p>
                                </div>
                            </li>
                            <li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="400ms">
                                ...
                                <div class="content-right">
                                    <h3>ITALIAN PIZZA</h3>
                                    <p>Naturally Dried Tomato, Cottage Cheese, Baby Corn & Green Bell Pepper...</p>
                                </div>
                            </li>
                            <li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="500ms">
                                <div class="content-left">
                                    <h3>CHEESE BURST PIZZA</h3>
                                    <p>Double Layered Cheese With Vegetables, Cottage Cheese & Dried Herbs...</p>
                                </div>
                            ...
                            <li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="600ms">
                                <div class="content-left">
                                    <h3>MEXICANA PIZZA</h3>
                                    <p>Bell Pepper, Onion, Corn, Olives, Jalapenos & Dried Herbs...</p>
                                </div>
                                <div class="blog-img-2">
                            ...
                            <li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="700ms">
                                ...
                                <div class="content-right">
                                    <h3>SPECIAL SMOKED CHICKEN PIZZA</h3>
                                    <p>Smoked Chicken Slices, Sausage, Bells And Red Paprika...</p>
                                </div>
                            </li>
                            <li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="800ms">
                                ...
                                <div class="content-right">
                                    <h3>ROYAL KING SIZE CHICKEN BURGER</h3>
                                    <p>Juicy Chicken Patty, Chicken Breast, Mayo Veggies & Double Cheese...</p>
                                </div>
                            </li>
                        </ul>
                        ...
                        <div class="pricing-list">
                            ...
                            <ul>
                                <li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                                    <div class="item">
                                        <div class="item-title">
                                            <h2>HOUSE SPECIAL FLAT BREAD PIZZA</h2>
                                ...
                                <li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="700ms">
                                    <div class="item">
                                        <div class="item-title">
                                            <h2>SPECIAL SMOKED CHICKEN PIZZA</h2>
                                            <div class="border-bottom"></div>
                                            <span>289.00/-</span>
                                        </div>
                                        <p>Smoked Chicken Slices, Sausage, Bells And Red Paprika</p>
                                ...
                                <li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="800ms">
                                    <div class="item">
                                        <div class="item-title">
                                            <h2>ROYAL KING SIZE CHICKEN BURGER</h2>
                                            <div class="border-bottom"></div>
                                            <span>195.00/-</span>
                                        </div>
                                        <p>Juicy Chicken Patty, Chicken Breast, Mayo Veggies & Double Cheese</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="block">
                        <p>Copyright &copy; 2022. Leaf 'n Beans. All Rights Reserved. </p>
                    </div>
                </div>
            </div>
        </div>
